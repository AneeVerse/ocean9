      ...
      <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-14 border-b border-white/15">
          ...
          <div className="lg:col-span-4 space-y-5">
            <div className="relative w-[220px] sm:w-[240px] h-[65px] sm:h-[75px]">
              <Image
            ...
            <p className="text-slate-200 text-sm sm:text-[15px] leading-relaxed max-w-sm">
            ...
            <div className="space-y-2.5 pt-1 text-xs sm:text-sm font-medium text-slate-200">
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="font-poppins text-lg sm:text-xl font-bold text-white tracking-tight">
              Quick Links
            </h4>
        ...
        {/* Bottom Copyright */}
        <div className="pt-8 text-center text-xs sm:text-sm text-slate-300 font-normal">
